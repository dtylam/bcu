        ...
        <div v-else>
            <md-table>
                ...
                <md-table-row v-for="record in records" :key="record.transactionId">
                    ...
                    <md-table-cell>
                      <a :href="'data:text/json;charset=utf-8,' + encodeURIComponent(JSON.stringify(record))" target="_blank" :download="record.transactionId + '.json'">
                      <md-button class="md-raised">View Raw</md-button>
                      </a>
                      </md-table-cell>                                                       
                </md-table-row>
            </md-table>
