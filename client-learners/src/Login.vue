<template>
    <div id="page">
        ...
        <div v-else class="login">
            <md-card>
                <md-card-header>
                    <div class="md-title my-center"><md-icon class="md-size-3x">credit_card</md-icon> Welcome, Jo Smith</div>
                </md-card-header>
            </md-card>   
        </div>
        <hr/>
        <div class="md-layout md-gutter md-alignment-center">
            <div class="md-layout-item md-medium-size-33 md-small-size-100">
                <div class="infobox">
                    ...
                    <p>All records are immutable and publicly verifiable,
                        enforced and governed by digital contracts between you and your teacher.
                    </p>
                </div>
            </div>
            <div class="md-layout-item md-medium-size-33 md-small-size-100">
                <div class="infobox">
                    ...
                    <p>Negotiate your personalised multi-disciplinary, cross-institutional curriculum.
                        Sky is the limit.
                    </p>
                </div>
            </div>
            <div class="md-layout-item md-medium-size-33 md-small-size-100">
                <div class="infobox">
                    ...
                    <h3>Transparent Evaluation and Feedback</h3>
                    <p>Education providers offer
                        clear learning objectives, 
                        lists of knowledge required before assessments, 
                        immutable marking schemes, and 
                        detailed feedback</p>
                </div>
            </div>
        </div>
